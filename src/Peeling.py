    ...
    while True:
        ...
        for i in range(d): 
            for j in range(m):
                ...
                clear_positions(elements, removers, counters, counters[i][j], count, hashf, d, sc, True)
...
def clear_positions(elements, positives, count_cms, count_cms_decrement, count, hashf, d, sc, is_positive):
    ...
    for i in range(num):
        ...
        for j in range(d):
            ...
            if is_positive:
                count_cms[j][jpos] -= count_cms_decrement
            ...
            if count_cms[j][jpos] == 0 and count[j][jpos] != 0:
    ...
    if len(additional) > 0:
        ...
        clear_positions(elements, additional, count_cms, 0, count, hashf, d, sc, False)
